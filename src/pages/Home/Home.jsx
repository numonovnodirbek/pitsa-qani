    ...
    <div>
      ...
      <section id="pizza">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Pizza" : "Пицца"}</h2>
          <select
            name="price"
            id="price"
      ...
      <section id="Sushi">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Sushi" : "Суши"}</h2>
          <select
            name="price"
            id="price"
      ...
      <section id="Appetizers">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Appetizers" : "Закуски"}</h2>
          <select
            name="price"
            id="price"
      ...
      <section id="Desserts">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Desserts" : "Десерты"}</h2>
          <select
            name="price"
            id="price"
      ...
      <section id="Beverages">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Beverages" : "Напитки"}</h2>
          <select
            name="price"
            id="price"
      ...
      <section id="Combo">
        <div className="heading">
          <h2>{selectedLanguage === "en" ? "Combo" : "Комбо"}</h2>
          <select
            name="price"
            id="price"
